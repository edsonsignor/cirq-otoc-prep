...
- Time-ordered correlators usually decay exponentially in strong interacting systems, but OTOCs use the backward evolution to refcous the correlations retaining useful info at late times.  
